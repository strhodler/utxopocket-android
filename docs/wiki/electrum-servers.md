...
summary: Why self‑hosting behind Tor matters, how public servers see your activity, and baseline monitoring tips.
...
- Monitor uptime, index status, and disk usage to prevent partial scans.
...
- [ ] Add basic monitoring and alerts for index status and node height.
