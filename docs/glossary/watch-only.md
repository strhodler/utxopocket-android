...
summary: A wallet that holds public data (descriptors, xpubs, addresses) to monitor balances and draft PSBTs without private keys.
related: [watch-only-restoration, descriptor-maps-and-recovery]
