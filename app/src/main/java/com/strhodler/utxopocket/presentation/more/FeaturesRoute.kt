...
private fun FeaturesScreen(onBack: () -> Unit) {
    val features = remember {
        listOf(
            ...
            FeatureItem(
                titleRes = R.string.feature_privacy_analysis_title,
                descriptionRes = R.string.feature_privacy_analysis_description
            ),
            FeatureItem(
            ...
            FeatureItem(
                titleRes = R.string.feature_security_title,
                descriptionRes = R.string.feature_security_description
            ),
            FeatureItem(
